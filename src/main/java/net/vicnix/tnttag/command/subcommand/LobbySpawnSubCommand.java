...
public class LobbySpawnSubCommand extends SubCommand {
    ...
    public void execute(Player player, String[] args) {
        ...
        level.setLobbySpawn(loc);
        level.handleUpdate();

        player.sendMessage(ChatColor.translateAlternateColorCodes('&', String.format("&9Lobby spawn set to &6X: &b%s &6Y: &b%s &6Z: &b%s &6Yaw: &b%s &6Pitch: &b%s", loc.getBlockX(), loc.getBlockY(), loc.getBlockZ(), loc.getYaw(), loc.getPitch())));
    }
}
